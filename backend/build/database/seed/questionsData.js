...
var Pragas;
(function (Pragas) {
    Pragas[Pragas["\u00C1gua em sangue"] = 1] = "\u00C1gua em sangue";
    Pragas[Pragas["R\u00E3s"] = 2] = "R\u00E3s";
    Pragas[Pragas["Mosquitos"] = 3] = "Mosquitos";
    Pragas[Pragas["Mosc\u00F5es"] = 4] = "Mosc\u00F5es";
    Pragas[Pragas["Morte dos Rebanhos"] = 5] = "Morte dos Rebanhos";
    Pragas[Pragas["Fur\u00FAnculos"] = 6] = "Fur\u00FAnculos";
    Pragas[Pragas["Granizo"] = 7] = "Granizo";
    Pragas[Pragas["Gafanhotos"] = 8] = "Gafanhotos";
    Pragas[Pragas["Escurid\u00E3o"] = 9] = "Escurid\u00E3o";
    Pragas[Pragas["Morte dos primog\u00EAnitos"] = 10] = "Morte dos primog\u00EAnitos";
})(Pragas || (Pragas = {}));
const questions = [
    {
        tier: 'n1',
        questions: [
            ...
            {
                question: 'Moisés ordenou que matassem cada israelita ligado a esse deus falso:',
                answer: 'Baal de Peor',
                options: ['Baal de Peor', 'Moloque', 'Quemos', 'Astarote'],
            },
            {
                question: 'Forma comum de livro durante o período de escrita da Bíblia:',
                answer: 'Rolo',
    ...
    },
    {
        ...
        questions: [
            ...
            {
                question: 'Filho de Azalias e secretário da corte, a quem Hilquias entregou o livro da lei',
                answer: 'Safã',
            ...
            {
                question: ' Jeová ordenou que Jacó morasse nesse lugar logo após Diná ser desonrada:',
                answer: 'Betel',
                options: ['Betel', 'Siquém', 'Hebrom', 'Mamré'],
            },
            {
                question: 'Para qual cidade Ló fugiu quando Sodoma e Gomorra foram destruídas?',
                answer: 'Zoar',
                options: ['Zoar', 'Belém', 'Betsaida', 'Jerusalém'],
            },
            {
                question: 'A perspicácia do homem o torna menos propenso a manifestar o quê? (Provérbios 19:11)',
                answer: 'Ira',
    ...
    },
    {
        ...
        questions: [
            ...
            {
                question: 'Idioma em que originalmente foi escrito o evangelho de Mateus:',
                answer: 'Hebraico',
                options: ['Hebraico', 'Latim', 'Grego', 'Aramaico'],
            },
            {
                question: 'Deus grego que o povo de Listra identificou como se fosse Barnabé:',
                answer: 'Zeus',
                options: ['Zeus', 'Hermes', 'Apolo', 'Dionísio'],
            },
            {
                question: 'Deus grego que o povo de Listra identificou como se fosse Paulo:',
                answer: 'Hermes',
    ...
    },
    {
        ...
        questions: [
            ...
            {
                question: 'Guerreiro geteu que foi leal a Davi durante a rebelião de Absalão:',
                answer: 'Itai',
                options: ['Itai', 'Benaia', 'Joabe', 'Simei'],
            },
            {
                question: 'Profeta que disse: \'Rasguem o seu coração, não as suas roupas\'',
                answer: 'Joel',
